    ...
    <nav class="flex justify-end px-5 py-3 text-gray-700  dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                ...
                <a href="#" class="ms-1 text-xs font-medium text-blue-400 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">{{__('Users')}}</a>
                </div>
            </li>
        </ol>
    </nav>
                ...
                <div class="grid grid-cols-3 gap-2 lg:grid-cols-5 lg:gap-2">
                      ...
                      <div class="justify-right px-4 py-4 mr-4">
                        ...
                        <div class="flex justify-end px-1 py-4 mr-4"> 
                            <a href="{{route('Admin.User.Create')}}" class="h-8 px-10 py-1 text-xs font-medium text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 whitespace-nowrap" title="{{__('New User')}}" >
        ...
        <x-card>
            @if ($users->count())
                    @foreach ($users as $user)
                        <div id="toast-interactive" class="justify-center inline-block mb-2 max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow-2xl dark:bg-gray-800 dark:text-gray-400" role="alert">
                            <div class="flex">
                                ...
                                <div class="ms-3 text-sm font-normal">
                                    ...
                                    <div class="mb-2 text-xs font-normal text-blue-600">{{$user->email}}</div> 
                                    <div class="mb-2">
                                        @if (!empty($user->getRoleNames()))
                                            @foreach ($user->getRoleNames() as $rolName)
                                                <h5 class="py-1 text-sm text-white text-bold text-center bg-cyan-500 border rounded-lg">{{$rolName}}</h5>
                                            @endforeach
                                        @endif
                                    </div>
                                    <div class="grid grid-cols-4 gap-4">
                                        ...
                                        <div>
                                            <a href="#" wire:click="update({{$user->id}})" class="border px-1 py-1 hover:bg-blue-100 focus:ring-4 focus:outline-none focus:ring-blue-100 dark:bg-blue-200 dark:hover:bg-blue-400 dark:focus:ring-blue-600" title="{{__('Edit')}}">
                                                <i class="far fa-edit fa-fw fa-lg" style="color: blue;"></i>
                                            </a>                                    
                                        </div>
                                        <div>
                                            <a href="#" class="border px-1 py-1 hover:bg-red-100 focus:ring-4 focus:outline-none focus:ring-red-100 dark:bg-red-200 dark:hover:bg-red-400 dark:focus:ring-red-600" title="{{__('Delete')}}">
