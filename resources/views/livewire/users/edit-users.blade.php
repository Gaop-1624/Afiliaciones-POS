<div>
    ...
    <x-card2>
        <x-titulo><i class="fas fa-user-edit fa-fw"></i></i> &nbsp; {{__('Edit user')}}</x-titulo>
    </x-card2>
    <x-card>
         <div class="grid grid-cols-1 gap-1 lg:grid-cols-2 lg:gap-2 m-2 mb-4 py-2">
                ...
                <div class="px-4 py-2 bg-blue-400">
                    <label for="small" class="block text-sm font-bold text-white dark:text-white">{{__('Asigne Rol al Usuario')}}</label>
                </div>
                <div class="px-4 py-2 border bg-slate-100 h-12 col-span-2">
                    <select  wire:model.defer="rol" wire:key="{{ $rol }}" id="small" class="block w-full p-2 mb-6 text-sm text-gray-900 border border-gray-300  bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 h-9">
