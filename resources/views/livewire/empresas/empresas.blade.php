<div>
    ...
    <x-titulo><i class="fas fa-building"></i> &nbsp; {{__('Company')}}</x-titulo>
    <x-card>
       <div class="grid grid-cols-2 gap-1 lg:grid-cols-4 lg:gap-2 mb-1  m-2">
                ...
                @else
                    <div class="px-2 py-2 border bg-slate-100 h-12 col-span-3">
                        <div class="relative mb-4">
                            ...
                            <label for="nit" class="absolute text-xs text-green-500 duration-300 transform -translate-y-3 scale-75 top-1 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-1 peer-focus:scale-75 peer-focus:-translate-y-3 start-1 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto font-bold">{{__('Document number')}}</label>
                        </div> 
                    </div>
                @endif
                @if ($errors->first('dev')) 
                ...
                @else
                    <div class="px-1 py-2 border bg-slate-100 h-12">
                        <div class="relative mb-4">
                            ...
                            <label for="dev" class="absolute text-xs text-green-500 duration-300 transform -translate-y-3 scale-75 top-1 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-1 peer-focus:scale-75 peer-focus:-translate-y-3 start-1 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto font-bold">{{__('Dv')}}</label>
                        </div> 
                    </div>
                @endif
            </div>
            ...
            @else
                <div class="px-4 py-2 border bg-slate-100 col-span-2 h-12">
                    <div class="relative mb-4">
                        ...
                        <label for="nombre" class="absolute text-xs text-green-500 duration-300 transform -translate-y-3 scale-75 top-1 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-1 peer-focus:scale-75 peer-focus:-translate-y-3 start-1 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto font-bold">{{__('Company name')}}</label>
                    </div> 
                </div>
            @endif 
        </div>
            ...
            @else
                <div class="px-2 py-2 border bg-slate-100  h-12">
                    <div class="relative mb-4">
                        ...
                        <label for="email" class="absolute text-xs text-green-500 duration-300 transform -translate-y-3 scale-75 top-1 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-1 peer-focus:scale-75 peer-focus:-translate-y-3 start-1 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto font-bold">{{__('Web page')}}</label>
                    </div> 
                </div>
            @endif
        ...
        <div class="mb-4 px-4 py-4 border bg-slate-100  m-2">
            ...
            <input class="block w-full text-sm text-green-600 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" id="multiple_files" type="file" multiple>
        </div> 
        <div class="flex justify-end border-x-0 mb-4">
            <button wire:click.prevent="update({{$empresa}})" class="px-6 py-1 mr-2 h-8 text-xs font-semibold text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300"><i class="fas fa-save fa-stack fa-lg"></i>{{__('Save')}} </button>
