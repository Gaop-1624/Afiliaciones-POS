            ...
            <flux:navlist variant="outline">
                <flux:navlist.item icon="home" :href="route('dashboard')" :current="request()->routeIs('dashboard')" wire:navigate>Dashboard</flux:navlist.item>
                    ...
                    @can('admin.users.index')
                         <flux:navlist.item icon="user-group" :href="route('Admin.Users')" :current="request()->routeIs('Admin.Users', 'Admin.User.Create', 'Admin.User.Edit')" wire:navigate>{{ __('Users') }}</flux:navlist.item>
                    @endcan
                    @can('admin.roles.index')
                            <flux:navlist.item icon="rectangle-group" :href="route('Admin.Roles')" :current="request()->routeIs('Admin.Roles', 'Admin.Roles.Create', 'Admin.Roles.Edit')" wire:navigate>{{ __('Roles') }}</flux:navlist.item>
                    @endcan
                    ...
                    <flux:navlist.item href="#">{{ __('Roles') }}</flux:navlist.item>
                </flux:navlist.group> --}}
